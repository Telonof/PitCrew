...
To begin, copy and paste ``en.json`` found in ``Languages``, rename it to the language culture code you'll be translating it to and edit any value inside the JSON.

A list can be found at: https://www.venea.net/web/culture-code
